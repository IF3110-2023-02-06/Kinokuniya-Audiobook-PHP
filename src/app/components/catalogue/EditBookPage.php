...
<head>
    ...
    <!-- Page-specific CSS -->
    <link rel="stylesheet" href="<?= BASE_URL ?>/styles/catalogue/editbook.css">
    ...
    <script type="text/javascript" src="<?= BASE_URL ?>/javascript/catalogue/editbook.js" defer></script>
</head>
<body>
    <div id="root">
        <?php
        ...
        <div class="summary-hidden" hidden><?= $bookData->book_desc ?></div>
        <?php include(dirname(__DIR__) . '/template/sidebar.php') ?>
        <main class="main-container">
            <?php include(dirname(__DIR__) . '/template/topnav.php') ?>
            <div class="secondary-container">
                <section class="add-book-section">
                    <form id="add-book-form" method="POST" autocomplete="on" action="/public/catalogue/edit" enctype="multipart/form-data">
                        <input type="hidden" name="book_id" value="<?= $bookData->book_id ?>">
                        <h2 class="add-book-header">Book Title</h2>
                        <div class="error-message" id="title-error"></div>
                        <input class="add-book-input" type="text" id="title" name="title" placeholder="Enter book title..." autocomplete="off" value="<?= $bookData->title ?>">
                        <h2 class="add-book-header">Author</h2>
                        <div class="error-message" id="author-error"></div>
                        <input class="add-book-input" type="text" id="author" name="author" placeholder="Enter book author..." autocomplete="off" value="<?= $bookData->author ?>">
                        <h2 class="add-book-header">Category</h2>
                        <div class="error-message" id="category-error"></div>
                        <input class="add-book-input" type="text" id="category" name="category" placeholder="Enter book category..." autocomplete="off" value="<?= $bookData->category ?>">
                        <h2 class="add-book-header">Publication Date</h2>
                        <div class="error-message" id="publication-date-error"></div>
                        <input class="add-book-input" type="date" id="publication-date" name="publication-date" value="<?= $bookData->publication_date ?>">
                        <h2 class="add-book-header">Price</h2>
                        <div class="error-message" id="price-error"></div>
                        <input class="add-book-input" type="number" id="price" name="price" step="1000" min="0" placeholder="Enter book price..." autocomplete="off" value="<?= $bookData->price ?>">
            ...
            <div class="overlay" id="overlay">
                <div class="confirmationPopup" id="confirmationPopup">
                    <div class="popupContent">
                        <h2 class="popupTitle">Confirm Edit</h2>
                        <p class="popupConfirmText">Are you sure you want to save the changes?</p>
                        <div class="popupButtons">
